...
help: ## Показать справку
	...
	@echo "  $(MAKE) train $(RED)MODEL=$(YELLOW)yolov8n-seg$(NC) $(RED)EPOCHS=$(GREEN)100$(NC) $(RED)OPTIMIZER=$(BLUE)SGD$(NC)        Произвольные аргументы"
	@echo "  $(MAKE) train $(RED)MODEL=$(YELLOW)yolov8n-seg$(NC) $(RED)LR=$(GREEN)0.001$(NC) $(RED)BATCH_SIZE=$(GREEN)16$(NC) $(RED)DEVICE=$(GREEN)cpu$(NC)"
