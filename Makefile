...
help: ## Показать справку
	...
	@echo "  $(GREEN)make train-yolo-n$(NC)       	— yolov8n-seg (50ep, AdamW, lr=0.0005, batch=8)"
	@echo "  $(GREEN)make train-yolo-s$(NC)       	— yolov8s-seg (50ep, AdamW, lr=0.0005, batch=8)"
	@echo "  $(GREEN)make train-yolo-m$(NC)       	— yolov8m-seg (50ep, AdamW, lr=0.0005, batch=8)"
	@echo "  $(GREEN)make train-yolo-l$(NC)       	— yolov8l-seg (50ep, AdamW, lr=0.0005, batch=8)"
	@echo "  $(GREEN)make train-yolo-xl$(NC)      	— yolov8x-seg (50ep, AdamW, lr=0.0005, batch=8)"
