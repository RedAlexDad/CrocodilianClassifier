...
3. Архитектура сверточной нейронной сети ResNet20.

## Дополнительные требования (2026)

### Web-приложение и сбор датасета
...
Требуется развернуть Minio для хранения загруженных изображений. Настроить интеграцию с Django-приложением через S3-совместимый API.
